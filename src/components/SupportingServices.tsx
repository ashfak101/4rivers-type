            ...
            <Container>
                ...
                <Box sx={{ display: 'flex', flexWrap: 'wrap', justifyContent:{ xs:'space-evenly', md:'space-between'},alignItems:'center', }}>
                    <Box sx={{ maxWidth: '310px', textAlign: 'center', position: 'relative',background: '#F2F2F2',py:4,borderRadius:'10px',mb:{xs:10,md:0},cursor:'pointer',transition:'all 0.3s ease','&:hover':{
                        ...
                        <Typography color='secondary.main' variant='h5' sx={{my:3}}>EQUIPMENT PARTS</Typography>
                        <Typography color='secondary.main' sx={{fontSize:'15px',p:1,mb:1}}>Moments mean dollars, and getting the right part when you are down is crucial to your success. 4Rivers Equipment’s parts experts can help you get up and running again in no time. Our specialty encompasses a wide range of John Deere products, from heavy equipment parts to farm machinery parts and beyond.</Typography>
                    ...
                    <Box sx={{ maxWidth: '310px', textAlign: 'center', position: 'relative',background: '#F2F2F2',py:4,borderRadius:'10px' ,mb:{xs:10,md:0},cursor:'pointer',transition:'all 0.3s ease','&:hover':{
                        ...
                        <Typography color='secondary.main' variant='h5' sx={{my:3}}>EQUIPMENT SERVICE</Typography>
                        <Typography color='secondary.main' sx={{fontSize:'15px',p:1,mb:1}}>Moments mean dollars, and getting the right part when you are down is crucial to your success. 4Rivers Equipment’s parts experts can help you get up and running again in no time. Our specialty encompasses a wide range of John Deere products, from heavy equipment parts to farm machinery parts and beyond.</Typography>
                        <PrimaryBtn text={'FIND OUT MORE'} />
                    </Box>
                    <Box sx={{ maxWidth: '310px', textAlign: 'center', position: 'relative',background: '#F2F2F2' ,py:4,borderRadius:'10px',mb:{xs:10,md:0},cursor:'pointer',transition:'all 0.3s ease','&:hover':{
                        ...
                        <Typography color='secondary.main' variant='h5'sx={{my:3}}>EQUIPMENT TECHNOLOGY</Typography>
                        <Typography color='secondary.main' sx={{fontSize:'15px',p:1,mb:1}}>Moments mean dollars, and getting the right part when you are down is crucial to your success. 4Rivers Equipment’s parts experts can help you get up and running again in no time. Our specialty encompasses a wide range of John Deere products, from heavy equipment parts to farm machinery parts and beyond.</Typography>
                        <PrimaryBtn text={'FIND OUT MORE'} />
                    </Box>
                </Box>
